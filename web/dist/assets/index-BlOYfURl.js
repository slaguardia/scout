    ...
    <div class="role-meta">
      ...
      <span class="role-company-wrap">
        <span class="role-company-row">
          ...
          ${e.verdict?`<span class="role-verdict"><span class="role-verdict-label">verdict</span> <span class="${y(e.verdict)}" title="scout's company-fit verdict">${r(e.verdict)}</span></span>`:""}
        </span>
