        ...
        <div className="settings-shell">
          ...
          <div className="settings-content" id="settings-content">
            {grp === "pipeline" ? (
              ...
              <>
                <SettingsTextField kind="application-stages" label="Application stages" desc="The application pipeline labels. One per line. “applied”, “rejected”, and “archived” are always kept; add your own stages between applied and rejected." rows={6} list />
