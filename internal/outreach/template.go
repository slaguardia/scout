...
{{closer: One or two tight sentences, then a simple low-friction ask ("Open to a quick call about the {{role}} role?"). If the sender hasn't worked in the company's specific domain but has done something genuinely adjacent, own that plainly — e.g. "I haven't worked in healthcare, but I know government-regulated data infrastructure is hard" — honest, and it still connects. A brief "I want to be part of it" is fine, but NO gush ("I'd love to be part of the team building the playbook for it") and don't list the company's challenges back at them. NEVER claim you've watched, seen, or lived the company's problem ("a problem I've watched up close for years") unless the docs specifically show it — same fabrication banned in the hook. Don't overclaim you've done their exact work; don't posture as "your next {{role}}".}}
